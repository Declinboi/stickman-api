...
import { clearCurrentJob, fetchJobById } from "../store/slices/jobsSlice";
...
export default function JobDetailPage() {
  ...
  // Subscribe to real-time WebSocket updates for this job
          ...
          {currentJob.status === "pending" && (
            <span
              className="flex items-center gap-2 text-yellow-400
                             bg-yellow-400/10 px-4 py-2 rounded-full text-sm"
            >
          ...
          {isProcessing && (
            <span
              className="flex items-center gap-2 text-blue-400
                             bg-blue-400/10 px-4 py-2 rounded-full text-sm"
            >
          ...
          {isCompleted && (
            <span
              className="flex items-center gap-2 text-green-400
                             bg-green-400/10 px-4 py-2 rounded-full text-sm"
            >
          ...
          {isFailed && (
            <span
              className="flex items-center gap-2 text-red-400
                             bg-red-400/10 px-4 py-2 rounded-full text-sm"
            >
